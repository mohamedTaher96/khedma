...
@section('content')
    @if (session('add'))
    <div class='alert alert-success'> تمت اضافة الخدمة الفرعية بنجاح</div>
    @endif
    @if (session('error'))
    <div class='alert alert-danger'> جميع البيانات مطلوبه ونوع الملف يجب ان يكون صوره</div>
    @endif
    <section class="content-header">
            <h1> إضافة خدمة فرعية</h1>
    </section>
    <section class="content">
            <div class="box box-primary">
                    <div class="box-header with-border">
                        <h2 class="box-title">خدمة فرعية جديد  </h2>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form action="add" method="post" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1"> اسم الخدمة الفرعية</label>

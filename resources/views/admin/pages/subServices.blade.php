...
@section('content')
    ...
    <section class="content-header">
            <h1>  الخدمات الفرعية </h1>
            <br>
    </section>
    <section class="">
        <div class="box">
                <div class="box-header">
                    <a href="/services/sub/new/{{$id}}" role="button" class="btn btn-primary" > إضافة خدمة فرعية</a>
                </div><!-- /.box-header -->
                <div class="box-body">
...
@section('script')
        ...
        <script src="{{asset('js/Tables.bootstrap.min.js')}}"></script>
        <script>
            $("#example1").DataTable();
            if($(".alert"))
            {
